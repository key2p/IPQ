...
echo 'CONFIG_DEBUG_INFO_DWARF5=y' >> ${MAIN_KCONFIG_FILE}
...
sed -i 's/CONFIG_DEBUG_INFO_COMPRESSED_NONE=[mny]/CONFIG_DEBUG_INFO_COMPRESSED_NONE=n/g'                ${MAIN_KCONFIG_FILE}
